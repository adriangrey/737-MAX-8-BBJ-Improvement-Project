...
- Added BBJ-style long-range fuel capacity to the default MSFS 2024 Boeing 737 MAX 8 BBJ preset.
- Increased total fuel capacity from approximately **45,694 lb** to approximately **69,499 lb**.
- Implemented as a modular merge patch targeting only the BBJ preset.
